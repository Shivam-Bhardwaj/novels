...
<!-- Arc: 2 | POV: Kael | Location: Tidemouth | Timeline: 2587, Month 3, Weeks 2-4 -->
<!-- Word count target: 2,500-3,000 -->
<!-- Beat sheet reference: CHAPTERS.md, Arc 2, Chapter 7 -->

<!-- BEAT 1: Kael goes public — reveals the signal to the scholarly council -->
...
<!-- BEAT 2: The coalition forms — scholars, traders, soldiers -->
...
<!-- BEAT 3: Building infrastructure — sustained communication begins -->
...
<!-- BEAT 4: The first fear — the entity has been waiting for a very long time -->
...
---
<!-- CONTINUITY NOTES:
- Kael revealed the signal to the scholarly council on a Tuesday (14 glass-eyes)
- Coalition formed: scholars (Kael), traders (Renna), soldiers (Commandant Hara)
- Observatory upgraded: better batteries, dedicated generator, proper switching mechanism
- Demi recruited 2 metalworkers from harbor
- Communication schedule: twice daily (morning + midnight)
- Exchanges now include: arithmetic, algebra, variables, equations
- Kael's private log entries: Days 41, 48, 52 — entity learns impossibly fast
- Kael estimates the probe signal is centuries old (based on carrier stability)
- Kael suspects she is talking to a machine (artificial intelligence)
- The entity corrected a deliberate error, understanding Kael's intentions
- Two systems observed: the unchanging probe beacon + the adaptive conversational partner
- Time: Month 3, Weeks 2-4
- Objects: Kael's private log (separate from official transcriptions)
- Foreshadowing: Kael's realization about AI, the "two systems" observation, the question of desperation
- Promise to reader: Why has the machine been calling for 500 years? What is it desperate to find?
-->
